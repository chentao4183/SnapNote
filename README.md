...
面向日常问题反馈、医疗信息化需求评审和系统验收的轻量截图批注工具。核心能力是 **智能标注**：在截图上拖一个框,一步生成「目标框 + 箭头 + 文字标签」组合,不用在矩形、箭头、文字工具之间反复切换。
...
- **智能标注**：拖框后自动生成目标框、箭头和文字标签,适合快速指出界面问题。
